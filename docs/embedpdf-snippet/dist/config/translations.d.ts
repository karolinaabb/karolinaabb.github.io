...
export declare const swedishTranslations: Locale;
export declare const japaneseTranslations: Locale;
export declare const traditionalChineseTranslations: Locale;
