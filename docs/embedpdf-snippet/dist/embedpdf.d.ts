...
export { AnnotationPlugin, type AnnotationPluginConfig, type AnnotationCapability, type AnnotationScope, type AnnotationEvent, type AnnotationTool, type AnnotationTransferItem, type ExportAnnotationsOptions, type GetAnnotationsOptions, type TrackedAnnotation, LockModeType, } from '@embedpdf/plugin-annotation/preact';
